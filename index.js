...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        game.innerHTML = `<img src="${games[i].img}" alt="game images">`;
        game.innerHTML += `<h3>${games[i].name}</h3>`;
        game.innerHTML += `<p>${games[i].description}</p>`;
...
let unfundedString = `There are currenttly ${unfundedGames.length} unfunded games. `;
